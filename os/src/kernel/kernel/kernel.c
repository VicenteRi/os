...
#error "This file is not meant to be compiled for Linux. It is an abstraction layer for the OS."
#endif

#if !defined(__i386__)
#error "This file is not meant to be compiled for a non-x86 architecture."
#endif
